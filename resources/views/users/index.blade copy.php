...
<div class="col-md-12 col-12" style="background-color: white; margin-left:20px; margin-right:20px">
@if(auth()->user()->isAdmin())
    <div class="card card-default" style="padding:20px;">
        <div class="card-header" style="border-bottom:1px solid blue; margin-bottom:30px; padding-bottom:20px"> <h3> Admins/Staff</h3></div>
        <div class="card-body">
        @if($users->count() > 0)
...
@else
    <h1 style="color:red">Contents are for Admin only.</h1>
@endif
</div>
</div>
@endsection
