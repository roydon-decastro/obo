...
<header>
  ...
  <!-- Full Page Intro -->
  <div class="view" style="background-image: url('/images/lines1.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    ...
    <div class="mask rgba-gradient d-flex justify-content-center align-items-center">
      ...
      <div class="intro-info-content text-center">
                    <h1 class="display-3 white-text mb-5 wow fadeInDown pt-5" data-wow-delay="0.3s">Thank you!</a></h1>
                    </ul>
