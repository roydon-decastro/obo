        ...
        <main class="header">
            <div class="container pt-5">
                ...
                <div class="intro-info-content text-center">
                    <h1 class="display-3 white-text mb-5 wow fadeInDown" data-wow-delay="0.3s">Search Results</a></h1>
                    </ul>
                    <h3 class=" white-text mb-5 mt-1 wow fadeInDown" data-wow-delay="0.3s">Please be informed that search results takes only the latest application record. To be precise please use the Application No. for searching your application.</h3>
