        ...
        <div class="col-md-12 col-sm-12 mb-4">
          ...
          <div class="card">
            ...
            @if(isset($permit))
                @method('PUT')
            @endif
          <h4 class="h4">Permit Details for <span class="blue-text">{{ substr($permit->application_id,0,8) . "-" . substr($permit->application_id,8,12) }}</span> </h4>
          <div class="row">
            <div class="col-md-3">
          ...
          <div class="row">
            ...
            <div class="form-group">
            <a href="{{ route('permits.edit', $permit->id) }}" class="btn btn-info btn-lg text-white">Edit Request</a>
            </div>
