...
<body>
    ...
    <input type="checkbox" style="position:absolute; top:183px; left:10px;">
    <input type="checkbox" style="position:absolute; top:183px; left:204px;">
    <input type="checkbox" style="position:absolute; top:183px; left:427px;">

    <input type="checkbox" style="position:absolute; top:211px; left:10px;">
    <input type="checkbox" style="position:absolute; top:211px; left:204px;">
    <input type="checkbox" style="position:absolute; top:211px; left:427px;">

    
    <input type="checkbox" style="position:absolute; top:239px; left:10px;">
    <input type="checkbox" style="position:absolute; top:239px; left:204px;">
    <input type="checkbox" style="position:absolute; top:239px; left:427px;">

    <input type="checkbox" style="position:absolute; top:267px; left:10px;">
    <input type="checkbox" style="position:absolute; top:267px; left:204px;">

    <input type="checkbox" style="position:absolute; top:281px; left:10px;">
    <input type="checkbox" style="position:absolute; top:281px; left:204px;">

    <input type="checkbox" style="position:absolute; top:295px; left:10px;">
    ...
    <table width="80%">
        <tr>
            ...
            <td  style="font-size: .5em; width:5%">ELP NO.</td>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:436px;  border-left: 1px solid; border-right: 1px solid; border-top:1px solid ">
        <tr >
            <td class="th" style="padding-left:5px"> <strong> NATURE OF INSTALLATION WORKS/EQUIPMENT SYSTEM:</strong></td>
        </tr>
    </table>
    <!--------------------------------------------- SCOPE OF WORK TABLE  -------------------------------------------------------->
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:464px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 30%; padding-left:25px;">TELECOMMUNICATION SYSTEM</td>
            <td class="th" style="width: 31%; ">ELECTRONICS FIRE ALARM SYSTEM</td>
            <td class="th" style="width: 39%; ">ELECTRONICS COMPUTERIZED PROCESS</td>
        </tr>
    </table>
    <!--------------------------------------------- NATURE OF CIVIL WORKS TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:478px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 30%; ;"></td>
            <td class="th" style="width: 31%; "></td>
            <td class="th" style="width: 39%; ">CONTROLS AUTOMATION SYSTEM</td>
        </tr>
    </table>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:492px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 30%; padding-left:25px;">BROADCASTING SYSTEM</td>
            <td class="th" style="width: 31%;">SOUND COMMUNICATION SYSTEM</td>
            <td class="th" style="width: 39%;">BUILDING AUTOMATION MANAGEMENT</td>         
        </tr>
    </table>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:506px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 30%; padding-left:25px;"></td>
            <td class="th" style="width: 31%;"></td>
            <td class="th" style="width: 39%;">AND CONTROL SYSTEM</td>         
        </tr>
    </table>
        ...
        <tr >
            <td class="th" style="width: 30%; padding-left:25px;">TELEVISION SYSTEM</td>
            <td class="th" style="width: 31%; ">CENTRALIZED CLOCK SYSTEM</td>
            <td class="th" style="width: 39%; ">BUILDING WIRING UTILIZING COPPER  </td>
        </tr>
    </table>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:534px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 30%; "></td>
            <td class="th" style="width: 31%; "></td>
            <td class="th" style="width: 39%; ">CABLE, FIBER OPTIC CABLE OR OTHER </td>
        </tr>
    </table>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:548px;  border-left: 1px solid; border-right: 1px solid;">
        <tr >
            <td class="th" style="width: 30%; padding-left:25px;">INFORMATION TECHNOLOGY SYSTEM</td>
            <td class="th" style="width: 31%; ">SOUND SYSTEM</td>
            <td class="th" style="width: 39%; ">MEDIAL ELECTRONIC SYSTEM </td>
        </tr>
    </table>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:562px;  border-left: 1px solid; border-right: 1px solid;">
        <tr >
            <td class="th" style="width: 30%; padding-left:25px;">SECURITY AND ALARM SYSTEM</td>
            <td class="th" style="width: 31%; ">ELECTRONICS CONTROL AND CONVEYOR SYSTEM</td>
            <td class="th" style="width: 39%; "></td>
        </tr>
    </table>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:576px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 100%; padding-left:25px;">AND OTHER ELECTRONICS AND IT SYSTEMS, EQUIPMENT, APPARATUS, DEVICE AND/OR COMPONENTS (Specify) _____________</td>
        </tr>
    </table>
    ...
    <!--------------------------------------------- NATURE OF CIVIL WORKS TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:604px;  border-left: 1px solid; border-right: 1px solid;">
        <tr >
    ...
    <!--------------------------------------------- SCOPE OF WORK TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:618px;  border-left: 1px solid; border-right: 1px solid;">
        <tr >
            <td class="th" style="width: 30%; padding-left:25px; color:white">A</td>
            <td class="th" style="width: 30%; padding-left:5px"></td>
            <td class="th" style="width: 40%; padding-left:5px"></td>
    ...
    <!--------------------------------------------- SCOPE OF WORK TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:632px;  border-left: 1px solid; border-right: 1px solid; border-bottom: 1px solid">
        <tr >
            <td class="th" style="width: 30%; padding-left:25px; color:white">A</td>
            <td class="th" style="width: 30%; padding-left:5px"></td>
            <td class="th" style="width: 40%; padding-left:5px"></td>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:646px;">
        <tr >
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:660px; border-left:1px solid; border-right:1px solid; border-top:1px solid">
        <tr>
            ...
            <td class="th" style="width: 50%; padding-left: 5px; border-bottom: 1px solid; border-left: 1px solid"> <strong>SUPERVISOR/IN-CHARGE OF ELECTRONIC  WORKS</strong> </td>
        </tr>
    </table>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:716px; border-left:1px solid; border-right:1px solid">
        <tr>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:730px; border-left:1px solid; border-right:1px solid">
        <tr>
            <td class="th" style="width: 5%; padding-left: 5px; color:white ">A</td>
            <td class="th" style="width: 40%; padding-left: 5px; text-align:center"> <strong> PROFESSIONAL ELECTRONICS ENGINEEER</strong></td>
            <td class="th" style="width: 5%; padding-left: 5px;  border-right: 1px solid"></td>
            <td class="th" style="width: 5%; padding-left: 5px; color:white ">A</td>
            <td class="th" style="width: 40%; padding-left: 5px; text-align:center;"> <strong> PROFESSIONAL ELECTRONICS ENGINEEER</strong></td>
            <td class="th" style="width: 5%; padding-left: 5px;  border-right: 1px solid"></td>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:744px; border-left:1px solid; border-right:1px solid; border-bottom:1px solid">
        <tr>
            <td class="th" style="width: 5%; padding-left: 5px; color:white ">A</td>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:786px; border-left:1px solid; border-right:1px solid">
        <tr>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:800px; border-left:1px solid; border-right:1px solid">
        <tr>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:814px;">
        <tr >
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:828px; border-left:1px solid; border-right:1px solid; border-top:1px solid">
        <tr>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:884px; border-left:1px solid; border-right:1px solid">
        <tr>
            <td class="th" style="width: 5%; padding-left: 5px; color:white ">A</td>
            <td class="th" style="width: 40%; padding-left: 5px;  border-bottom: 1px solid"></td>
            <td class="th" style="width: 5%; padding-left: 5px;  border-right: 1px solid"></td>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:926px; border-left:1px solid; border-right:1px solid">
        <tr>
            <td class="th" style="width: 50%; padding-left: 5px; border-bottom: 1px solid">Address</td>
            <td class="th" style="width: 50%; padding-left: 5px; border-bottom: 1px solid; border-left: 1px solid">Address</td>
        </tr>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:940px; border-left:1px solid; border-right:1px solid; border-bottom:1px solid">
        <tr>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:954px;">
        <tr >
  ...
  <input type="checkbox" style="position:absolute; top:-185px; left:350px;">
    ...
    <table width="100%" style="border-collapse: collapse; border-left:1px solid; border-right:1px solid;">
        <tr>
            <td class="th" style="width: 40%; padding-left: 5px;"></td>
            <td class="th" style="width: 30%; padding-left: 5px; "> <strong> FIVE(5) SETS OF ELECTRONICS DOCUMENTS</strong></td>
            <td class="th" style="width: 30%; padding-left: 5px; "></td>
        </tr>
    </table>
