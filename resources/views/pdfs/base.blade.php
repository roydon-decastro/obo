...
<body>
    ...
    <table width="80%">
        <tr>
            ...
            <td  style="width:50%">201908-0001</td>
    ...
    <table width="80%" style="border-collapse: collapse; float:left;  border: 1px solid ">
        ...
        <tr style="">
            ...
            <td style="border-bottom: 1px solid; width: 20%">Anders</td>
            <td style="border-bottom: 1px solid; width: 25%">Buenaventura</td>
            <td style="border-bottom: 1px solid; width: 15%">I</td>
            <td style="border-bottom: 1px solid; width: 15%; border-left: 1px solid; padding-left:5%">xxxxxxxxxx</td>
        ...
        <tr>
            ...
            <td style="border-bottom: 1px solid; width: 30%; border-left: 1px solid; padding-left:5%">Partnership</td>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="80%" style="border-collapse: collapse; position:absolute; top:262px;  border-left: 1px solid;border-right: 1px solid;border-bottom: 1px solid;  ">
        <tr >
        ...
        <tr >
            ...
            <td style="width: 15%">Bridgewater</td>
            <td style="width: 20%">San Vicente Central </td>
            <td style="width: 20%;">Calapan City</th>
            <td style="width: 10%;">1611</td>
            <td style="width: 20%; border-left: 1px solid; padding-left:5%">0919-2907360</td>
        </tr>
    </table>    
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="80%" style="border-collapse: collapse; position:absolute; top:296px;  border-left: 1px solid; border-right: 1px solid ">
        <tr>
            ...
            <td            style="width: 3%; border-bottom: 1px solid;">20</td>
            <td class="th" style="width: 5%;"></td>
            <td class="th" style="width: 5%">BLK. NO.</td>
            <td            style="width: 3%; border-bottom: 1px solid;">31</td>
            <td class="th" style="width: 5%;"></td>
            <td class="th" style="width: 5%">TCT. NO.</td>
            <td class="th" style="width: 6%; border-bottom: 1px solid;"></td>
    ...
    <table width="80%" style="border-collapse: collapse; position:absolute; top:315px;  border-left: 1px solid; border-right: 1px solid; border-bottom: 1px solid ">
        <tr>
            ...
            <td            style="width: 10%; border-bottom: 1px solid;">Bridgewater</td>
            <td class="th" style="width: 1%;"></td>
            <td class="th" style="width: 5%">BARANGAY</td>
            <td            style="width: 15%; border-bottom: 1px solid;">San Vicente Central </td>
            <td class="th" style="width: 1%;"></td>
    ...
    <table width="80%" style="border-collapse: collapse; position:absolute; top:517px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 50%; padding-left:25px">NUMBER OF STOREY(S)_____________________________________</td>
            <td class="th" style="width: 50%; padding-left:5px">PROPOSED DATE OF CONSTRUCTION_______________________</td>
        </tr>
    </table>
    ...
    <table width="80%" style="border-collapse: collapse; position:absolute; top:531px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 50%; padding-left:25px">TOTAL FLOOR AREA___________________SQUARE METERS</td>
            <td class="th" style="width: 50%; padding-left:5px">EXPECTED DATE OF COMPLETION_______________________</td>
        </tr>
    </table>
    ...
    <table width="80%" style="border-collapse: collapse; position:absolute; top:545px;  border-left: 1px solid; border-right: 1px solid;  ">
        <tr >
            <td class="th" style="width: 50%; padding-left:25px">TOTAL ESTIMATED COST P__________(<span style="font-size:.7em">for Statistical Purposes Only</span>)</td>
            <td class="th" style="width: 50%; padding-left:5px; margin-bottom: 10px;">__________________________________________________________</td>
        </tr>
    </table>
