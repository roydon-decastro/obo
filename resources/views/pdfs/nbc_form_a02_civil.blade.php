...
<body>
    ...
    <div class="gitna">
        <ul class="bulit">
            ...
            <li class="liit" style="color:white">a</li>
            <li><h5></strong>CIVIL/STRUCTURAL PERMIT</strong></h5></li>
        </ul>
    </div>
    <table width="80%">
        <tr>
    ...
    <!--------------------------------------------- TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:454px;">
        <tr >
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:473px;  border-left: 1px solid; border-right: 1px solid; border-top:1px solid ">
        <tr >
            <td class="th" style="padding-left:5px">NATURE OF CIVIL/STRUCTURAL WORKS</td>
        </tr>
    </table>
    <!--------------------------------------------- NATURE OF CIVIL WORKS TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:487px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 40%; padding-left:25px;">STAKING</td>
            <td class="th" style="width: 30%; padding-left:5px">ERECTION/LIFTING</td>
            <td class="th" style="width: 30%; padding-left:5px">PRESTRESS WORKS</td>
        </tr>
    </table>
    <!--------------------------------------------- NATURE OF CIVIL WORKS TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:501px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 40%; padding-left:25px;">EXCAVATION</td>
            <td class="th" style="width: 30%; padding-left:5px">CONCRETE FRAMING</td>
            <td class="th" style="width: 30%; padding-left:5px">MATERIAL TESTING</td>         
        </tr>
    </table>
    <!--------------------------------------------- NATURE OF CIVIL WORKS TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:515px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 40%; padding-left:25px;">SOIL STABILIZATION</td>
            <td class="th" style="width: 30%; padding-left:5px">STRUCTURAL STEEL FRAMING</td>
            <td class="th" style="width: 30%; padding-left:5px">STEEL TOWERS</td>
        </tr>
    </table>
    <!--------------------------------------------- NATURE OF CIVIL WORKS TABLE  -------------------------------------------------------->
    <table width="100%" style="border-collapse: collapse; position:absolute; top:529px;  border-left: 1px solid; border-right: 1px solid;">
        <tr >
            <td class="th" style="width: 40%; padding-left:25px;">PILING WORKS</td>
            <td class="th" style="width: 30%; padding-left:5px">SLABS</td>
            <td class="th" style="width: 30%; padding-left:5px">TANKS</td>
        </tr>
    </table>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:543px;  border-left: 1px solid; border-right: 1px solid; ">
        <tr >
            <td class="th" style="width: 40%; padding-left:25px;">FOUNDATION</td>
            <td class="th" style="width: 30%; padding-left:5px">WALLS</td>
            <td class="th" style="width: 30%; padding-left:5px">OTHERS(Specify)______________________________</td>
        </tr>
    </table>
    ...
    <table width="100%" style="border-collapse: collapse; position:absolute; top:725px; border-left:1px solid; border-right:1px solid">
        <tr>
            <td class="th" style="width: 5%; padding-left: 5px; color:white ">A</td>
            <td class="th" style="width: 40%; padding-left: 5px; text-align:center"> <strong> CIVIL/STRUCTURAL ENGINEER</strong></td>
            <td class="th" style="width: 5%; padding-left: 5px;  border-right: 1px solid"></td>
            <td class="th" style="width: 5%; padding-left: 5px; color:white ">A</td>
            <td class="th" style="width: 40%; padding-left: 5px; text-align:center;"> <strong> CIVIL/STRUCTURAL ENGINEER</strong></td>
            <td class="th" style="width: 5%; padding-left: 5px;  border-right: 1px solid"></td>
  ...
  <input type="checkbox" style="position:absolute; top:-185px; left:350px;">
    ...
    <table width="100%" style="border-collapse: collapse; border-left:1px solid; border-right:1px solid;">
        <tr>
            ...
            <td class="th" style="width: 45%; padding-left: 5px;">CIVIL/STRUCTURAL DESIGN COMPUATIONS, PLANS & SPECIFICATIONS</td>
   ...
   <!--------------------------------------------- TABLE  -------------------------------------------------------->
    ...
    <table width="100%" style="border-collapse: collapse; border-left:1px solid; border-right:1px solid; ">
        <tr>
            <td class="th" style="width: 40%; padding-left: 5px; border-right: 1px solid; border-bottom: 1px solid;">CIVIL/STRUCTURAL</td>
    ...
    <div style="border-left:1px solid; border-right:1px solid">
        <ol>
            ...
            <li class="th">That the proposed civil/structural works shall be in accordance with the civil/structural plans filed with this office and in conformity with the latest National Structural Code of the Philippines, the National Building Code and its IRR.</li>
            <li class="th">That prior to any construction activity, a duly accomplished prescribed "Notice of Construction" shall be submitted to the Office of the Building Official</li>
            <li class="th">That upon completion of the construction, the licensed full-time inspector and supervisor/in charge of construction works shall submit the entry to the logbook duly signed and sealed to the Building Official including as-build plans and other documents and shall also accomplish and submit a certificate of completion stating that the civil/structural works conform to the provisions of the National Structural Code of the Philippines, the National Building Code and its IRR.</li>
