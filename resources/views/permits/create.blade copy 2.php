...
<!-- Heading -->
      ...
      <div class="row wow fadeIn" style="background-color:white; padding:0 15px; margin:10px 0">
        ...
        <div class="col-md-12 col-sm-12 mb-4">
          ...
          <!--Card-->
          <div style="border-bottom:1px solid blue; padding:10px 0; border-bottom:1px grey; background-color:white;  font-size:2rem">Update Permit</div>
            <!--Card-->
            <div class="card" style="border-top: 1px solid #64c4ed; padding-top:20px">
            <!--Card content-->
            <div class="card-body">
            ...
            @if(isset($permit))
                @method('PUT')
            @endif
          <h3 class="h3">Permit Details  for Application Number: <span style="color:#64c4ed; "> {{isset($permit) ? substr($permit->application_id,0,8) . "-" . substr($permit->application_id,8,12) : ""}}</span></h3>
